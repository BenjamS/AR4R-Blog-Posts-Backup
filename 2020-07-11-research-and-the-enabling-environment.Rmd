...
India: 2 million (wikipedia)



By 1878, a British statistician counted 31 serious famines in 120 years of British rule versus 17 famines in the previous two milennia [Walford (1878) in @davis2002late].
...
df_IndiaCereal$Item[grep("Coarse", df_IndiaCereal$Item)] <- "Coarse grains"
...
df_plot$Item[grep("Jowar|Ragi|Bajra|Barley", df_plot$Item)] <- "Coarse grains"
df_plot <- subset(df_plot, Item %in% c("Coarse grains", "Maize", "Wheat", "Rice"))
...
df_plot$`Production per capita (metric tons)` <- 
